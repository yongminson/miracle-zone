...
export function LockWall({ initialLockId }: { initialLockId?: string }) {
  ...
  useEffect(() => {
    ...
    const sharedId = initialLockId ?? new URLSearchParams(window.location.search).get("id");
    if (!sharedId) return;
