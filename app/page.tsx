          ...
          <div className="mt-20 border-t border-slate-800/60 pt-16">
            ...
            <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                { href: "/tools?tab=palmistry", emoji: "✋", title: "손금 분석", desc: "AI 손금 분석 · 재물·결혼·건강·직업운", badge: "무료~", badgeColor: "bg-emerald-500/20 text-emerald-300 border-emerald-500/30" }, desc: "AI 관상 분석 · 성명학 이름풀이", badge: "4,900원", badgeColor: "bg-amber-500/20 text-amber-300 border-amber-500/30" },
