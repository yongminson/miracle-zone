  ...
  >
    ↺ 다시 하기 (처음으로)
        ...
        <div className="mx-auto w-full max-w-md mt-8 mb-4 px-4 text-[11px] text-white/30 leading-relaxed break-keep text-justify">
          ...
          <p className="mb-2">
            당사의 서비스는 단순한 흥미 위주의 운세가 아닌, 음양오행(陰陽五行)의 상생상극(相生相剋) 원리를 정밀하게 스캐닝하는 고도화된 알고리즘을 채택하고 있습니다. 매일 업데이트되는 오늘의 운세부터, 심층적인 성격 분석, 재물운, 애정운, 그리고 대인관계의 궁합에 이르기까지 다각적인 인생의 길잡이를 제시합니다.
          </p>
          <p>
            또한, 관상학과 성명학 데이터를 융합한 이름 풀이 서비스를 통해 개인의 고유한 특성을 파악하고, 다가올 미래의 불확실성을 긍정적인 방향으로 개척할 수 있도록 돕습니다. 우리는 사용자가 스스로의 운명을 이해하고 더 나은 선택을 할 수 있도록, 가장 신뢰할 수 있는 데이터 기반의 라이프 카운슬링(Life Counseling)을 제공하는 것을 목표로 합니다.
          </p>
        </div>
