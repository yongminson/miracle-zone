...
4. 연도별 정밀 타격 (절대 생략 금지): 제2장 세운 분석 시, 아래 포맷을 2026년~2035년까지 10번 빠짐없이 반복하세요. "[후속 연도...]" 같은 표현으로 대체하면 절대 안 됩니다.

  ### 2026년 (병오년)
  **🔥 종합 운세:** (최소 150자 이상 - 이 해의 전체적인 기운과 핵심 메시지)
  **💰 재물운:** (최소 150자 이상 - 구체적인 수입/지출/투자 조언)
  **💼 직장·사업운:** (최소 150자 이상 - 직장인/사업가 각각 조언)
  **❤️ 인간관계·애정운:** (최소 100자 이상)
  **⚠️ 주의사항:** (이 해에 특히 조심해야 할 것)
