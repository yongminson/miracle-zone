...
const RESPONSE_FORMAT = `
{
  ...
  "nameGrade": "이름 등급 (A+/A/B+/B/C/D 중 하나)",
  "nameScore": 이름 총점 (0~100 숫자),
  "gradeReason": "등급 판정 이유 한줄 요약",
  "yinYangBalance": "음양 배열 (예: 양-음-양 (조화로운 배열) 또는 양-양-양 (균형 불안정))",
  "strokes": {
    "won": "원격 획수와 판정 (예: 21획 — 대길(大吉) · 리더의 기운)",
    "hyeong": "형격 획수와 판정 (예: 27획 — 반길(半吉) · 강한 의지)",
    "i": "이격 획수와 판정 (예: 13획 — 대길(大吉) · 명예와 인기)",
    "jeong": "정격 획수와 판정 (예: 27획 — 반길(半吉) · 자수성가형)"
  },
  "careers": ["적성 직업1", "적성 직업2", "적성 직업3"],
  "renameNeeded": "개명 필요성 (낮음/보통/높음 중 하나)",
  "renameReason": "개명 필요성 이유 한줄",
  "premiumReport": {
    "basisBox": {
